                ...
                <div class="navbar-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="Done.php" class="dropdown-item active">Done</a>
                                <a href="Approved.php" class="dropdown-item">Approved</a>
...
<div class=" container-fluid mt-3" >
        <div class="card shadow-lg " style = "width: auto;height:auto">
            ...
            <h5 class="card-header bg-primary text-center text-light">Appointments<small class = "bg-success rounded p-1">(Done)</small></h5>
            
            
              <?php

    $query = "SELECT * , status.stat FROM appointment,status WHERE appointment.statid = status.statid AND appointment.statid = 3 ";
