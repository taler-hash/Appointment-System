                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="Pending.php" class="dropdown-item active">Pending</a>
                            </div>
                        </div>
...
<div class=" container-fluid mt-3" >
        <div class="card shadow-lg " style = "width: auto;height:auto">
            ...
            <h5 class="card-header bg-primary text-center text-light">Appointments<small class = "bg-warning rounded p-1">(Pending)</small></h5>
            
            
              <?php

    $query = "SELECT * , status.stat FROM appointment,status WHERE appointment.statid = status.statid AND appointment.statid = 1 ";
