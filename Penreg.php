...
<body class = "bg-warning text-dark bg-opacity-25">
  <header>
    ...
    <div class="navbar navbar-warning bg-warning shadow-sm">
      ...
      <h4 class = "text-white fw-bold"> Pending / Registration </h4>
...
<div id="toastdeclined" class="position-fixed bottom-0 end-0 p-3" style="z-index: 11; width:350px">
...
<?php
  ...
  ?>
            ...
            <table cellspacing="5" cellpadding="5"  id ="Alldata1" class="table table-striped border shadow-lg ">
  ...
  <div class = "row">
          ...
          <div class = "row">
            ...
            <div class = "col-4">
              ...
              <input type="text" id="pengradestatus" class="form-control bg-warning text-white fw-bold h4" aria-label="Default" aria-describedby="inputGroup-sizing-default" value = "Pending" readonly  readonly>
        ...
        <input hidden type="text" name = "statdecline"  class=" none" aria-label="Default" aria-describedby="inputGroup-sizing-default" style="border:0;" value="4" readonly>
         <div class = "row">
          ...
          <h6 class="" >Reason:</h6>
              ...
              <div class = "  ">
              <textarea type="text" id="declinereason" name = "declinereason" rows="4" cols="50" class="form-control col-4 fw-bold h4" aria-label="Default" aria-describedby="inputGroup-sizing-default" ></textarea> 
          </div>
