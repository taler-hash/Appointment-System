            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <div class="nav-item dropdown">
                            ...
                            <a href="TOR.php" class="dropdown-item active">TOR</a>
...
<div class=" container-fluid mt-3" >
        <div class="card shadow-lg " style = "width: auto;height:auto">
            ...
            <h5 class="card-header bg-primary text-center text-light">Appointments</h5>
            
            
              <?php

    $query = "SELECT * , status.stat FROM appointment,status WHERE appointment.statid = status.statid AND appoint_type = 'TOR'";
