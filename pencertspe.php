...
?>
<!DOCTYPE html>
<title>Pending / Cert of (Specify)</title>
<head>
...
<body class = "bg-warning text-dark bg-opacity-25">
  <header>
    ...
    <div class="navbar navbar-warning bg-warning shadow-sm">
      ...
      <h4 class = "text-white fw-bold"> Pending / Cert of (Specify) </h4>
...
$query = "SELECT * FROM appointment WHERE statid = 1 AND appoint_type like '%Cert of%'";
