...
?>
<!DOCTYPE html>
<title>Pending / True Copy (Sets)</title>
<head>
...
<body class = "bg-warning text-dark bg-opacity-25">
  <header>
    ...
    <div class="navbar navbar-warning bg-warning shadow-sm">
      ...
      <h4 class = "text-white fw-bold"> Pending / True Copy (Sets) </h4>
...
<?php
  ...
  <script>
    ...
    $query = "SELECT * FROM appointment WHERE statid = 1 AND appoint_type like '%Certificate True Copy%'";
